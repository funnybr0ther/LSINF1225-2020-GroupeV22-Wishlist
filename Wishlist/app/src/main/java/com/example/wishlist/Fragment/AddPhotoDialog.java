...
public class AddPhotoDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable final Bundle savedInstanceState) {
        ...
        takePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                AddPhotoDialog.this.startActivityForResult(cameraIntent, AddPhotoDialog.this.CAMERA_REQUEST_CODE);
            }
        });
        ...
        selectPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                AddPhotoDialog.this.startActivityForResult(memoryIntent, AddPhotoDialog.this.MEMORY_REQUEST_CODE);
            }
        });
        return view;
    }
    ...
    public void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        ...
        if (requestCode == this.CAMERA_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            final CreateProfileActivity activity = (CreateProfileActivity) this.getActivity();
        ...
        if (requestCode == this.MEMORY_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            this.onPhotoReceivedListener.getUriImage(selectedImageUri);
            this.getDialog().dismiss();
        }
    }
}
